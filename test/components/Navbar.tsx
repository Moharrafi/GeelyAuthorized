...
const Navbar: React.FC<NavbarProps> = ({ onTestDriveClick, onNavigate, currentView, theme, onToggleTheme }) => {
  ...
  return (
    ...
    >
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <div className="flex items-center gap-4 ml-4">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-2.5 font-bold text-xs uppercase tracking-widest rounded-full transition-all duration-300 hover:-translate-y-0.5 shadow-lg ${
                theme === 'dark' 
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute top-full left-0 w-full transition-all duration-500 overflow-hidden border-b ${
