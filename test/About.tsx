...
// Data gambar pengiriman (Hanya URL Gambar untuk fokus visual)
const GALLERY_IMAGES = [
  ...
  { id: 3, url: "https://images.unsplash.com/photo-1503376763036-066120622c74?auto=format&fit=crop&q=80&w=800", size: "medium" },
...
const About: React.FC<AboutProps> = ({ onConsultClick }) => {
  return (
    <div className="pt-24 md:pt-20 bg-white min-h-screen text-slate-900 overflow-x-hidden">
      
      {/* Hero Section */}
      <section className="relative h-[60vh] md:h-[50vh] flex items-center justify-center overflow-hidden border-b border-slate-100">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <h1 className="text-4xl md:text-7xl font-bold text-slate-900 mb-6 leading-tight tracking-tighter">
            Dayana <span className="text-accent">Sastro</span>
          </h1>
          <p className="text-slate-500 max-w-xl mx-auto text-lg font-light leading-relaxed mb-10">
          ...
          <button 
            ...
            className="px-10 py-4 bg-slate-900 text-white font-bold rounded-full hover:bg-accent hover:text-slate-900 transition-all flex items-center justify-center gap-3 mx-auto shadow-2xl group uppercase tracking-widest text-[10px]"
          >
            Hubungi Dayana
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="columns-1 sm:columns-2 lg:columns-3 gap-8 space-y-8">
            {GALLERY_IMAGES.map((item) => (
              <div 
                key={item.id} 
                className="relative group overflow-hidden rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:shadow-accent/10 transition-all duration-700 cursor-zoom-in"
              >
                ...
                <div className="absolute top-6 right-6 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                   <div className="w-12 h-12 bg-white/90 backdrop-blur-md rounded-full flex items-center justify-center text-accent shadow-xl border border-white/50">
          ...
          <div className="mt-20 flex flex-col items-center">
             <div className="flex items-center gap-8 mb-10">
                <div className="text-center">
                    <div className="text-4xl font-bold text-slate-900 tracking-tighter">480+</div>
                    <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Units Sold</div>
                </div>
                <div className="w-px h-10 bg-slate-200"></div>
                <div className="text-center">
                    <div className="text-4xl font-bold text-slate-900 tracking-tighter">100%</div>
                    <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Trust Rate</div>
                </div>
             </div>
             <p className="text-slate-400 text-sm font-light italic">"Setiap unit adalah bukti dedikasi kami."</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="w-full lg:w-1/2">
               <div className="relative rounded-[3rem] overflow-hidden border border-white shadow-2xl aspect-square">
                  <img 
            ...
            <div className="w-full lg:w-1/2">
               <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 text-slate-500 rounded-full mb-8">
               ...
               <div className="grid grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={idx} className="p-8 bg-white rounded-3xl border border-slate-200 hover:border-accent/20 transition-all group">
