...
const CarShowcase: React.FC<CarShowcaseProps> = ({ onTestDriveClick }) => {
  ...
  return (
    <section id="models" className="pt-20 pb-12 md:pt-32 md:pb-16 bg-slate-950 relative overflow-hidden">
      {/* Decorative background text */}
      <div className="absolute top-20 md:top-40 left-0 text-[10rem] md:text-[15rem] font-black text-white/[0.02] select-none pointer-events-none whitespace-nowrap leading-none uppercase">
        Masterpiece • 2025
      </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 w-full lg:w-auto items-start sm:items-center">
            ...
            <div className="w-full sm:w-auto overflow-visible relative">
              <div className="overflow-x-auto no-scrollbar py-2">
                <div className="inline-flex items-center bg-slate-900/60 p-1.5 md:p-2 rounded-full border border-slate-800 backdrop-blur-md shadow-2xl min-w-max">
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-full text-[10px] font-black tracking-widest transition-all duration-500 ease-out whitespace-nowrap ${
                      selectedCategory === null
                        ? 'bg-white text-slate-950 shadow-[0_0_20px_rgba(255,255,255,0.4)] scale-[1.02]'
              ...
              filteredAndSortedCars.map((car) => (
                ...
                >
                  <div 
                    ...
                    className="relative w-full bg-slate-900 rounded-[2.5rem] md:rounded-[3rem] overflow-hidden border border-slate-800 group/card cursor-pointer flex flex-col lg:flex-row shadow-2xl"
                  >
                    {/* Image Area */}
                    ...
                    <div className="w-full lg:w-[40%] p-10 md:p-16 flex flex-col justify-center">
                        ...
                        <h3
                          className={`font-bold text-white mb-8 md:mb-6 tracking-tighter leading-none ${
                            car.name === 'Geely Starray EM-i' ? 'text-2xl md:text-5xl' : 'text-3xl md:text-6xl'
                          }`}
                        >
                          {car.name}
                        </h3>
