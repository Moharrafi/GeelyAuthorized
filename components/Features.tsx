...
const MODEL_TECH = [
  {
    ...
    series: 'Urban EV',
    accentColor: '#3b82f6',
    heroImage: '/img/technology/ex2_hero.jpg',
    ...
    highlights: [
      { image: '/img/technology/ex2_highlight_1.jpg', title: 'Double The Space', desc: 'Desain bagasi depan (Frunk) dan bagasi belakang serbaguna yang lapang, cerdas, dan fleksibel.' },
      { image: '/img/technology/ex2_highlight_2.png', title: 'Double the Driving Pleasure', desc: 'Lincah dan menyenangkan dengan radius putar minimum 4.95m untuk kenyamanan bermanuver di perkotaan.' },
      { image: '/img/technology/ex2_highlight_3.jpg', title: 'Double The Safety & Ease', desc: 'Perlindungan aktif cerdas dengan sistem Lane Change Assist (LCA) dan DOW untuk keselamatan maksimal.' },
      { image: '/img/technology/ex2_highlight_4.jpg', title: 'Double The Tech Joy', desc: 'Layar sentuh HD tengah 14.6 inci dan panel instrumen LCD 8.8 inci yang terintegrasi secara cerdas.' },
    ],
    ...
    extraImage: '/img/technology/ex2_extra.jpg',
  ...
  },
  {
    ...
    highlights: [
      { image: '/img/technology/ex5_highlight_1.jpg', title: 'GEA — Electric Architecture', desc: 'Platform cerdas GEA generasi baru mengoptimalkan ruang, efisiensi energi, keamanan, kecerdasan buatan (AI), dan performa.' },
      { image: '/img/technology/ex5_highlight_2.jpg', title: 'Short Blade Battery', desc: 'Baterai LFP generasi terbaru yang mendukung pengisian daya cepat (fast charging) untuk meminimalkan waktu tunggu.' },
      ...
      { image: '/img/technology/ex5_highlight_4.png', title: 'FLYME SOUND Audio', desc: 'Sistem audio Dolby Atmos dengan amplifier independen 1000W dan 16 speaker untuk kualitas suara murni sekelas konser.' },
    ],
    ...
    extraImage: '/img/technology/ex5_extra.jpg',
  ...
  },
  {
    ...
    series: 'Super Hybrid',
    accentColor: '#f59e0b',
    heroImage: '/img/technology/starray_hero.webp',
    ...
    highlights: [
      ...
      { image: '/img/technology/starray_highlight_2.webp', title: '15.4" HD Central Screen', desc: 'Layar sentuh resolusi tinggi 15.4 inci yang terintegrasi secara cerdas untuk navigasi dan hiburan.' },
      { image: '/img/technology/starray_highlight_3.webp', title: '256-Color Ambient Lights', desc: 'Pencahayaan kabin ambient 256 warna dinamis yang melengkapi kemewahan interior berkendara Anda.' },
      { image: '/img/technology/ex5_highlight_4.png', title: 'FLYME SOUND Audio', desc: 'Nikmati kualitas audio sejernih kristal dari konfigurasi 16 speaker dengan amplifier bertenaga 1000W.' },
    ],
    ...
    extraImage: '/img/technology/starray_extra.webp',
